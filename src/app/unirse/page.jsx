...
const PLANES_INDIVIDUAL = [
  {
    ...
    features: [
      "Perfil público verificado en el marketplace",
      "Botón WhatsApp directo",
      "Información de contacto y redes",
      "Publicación en redes de Medify",
    ],
    flujo: "wsp",
    activacion: "Nuestro equipo recibe tu solicitud y activa tu perfil en menos de 24 horas.",
  },
  {
    id: "profesional",
    name: "Profesional",
    ...
    features: [
      ...
      "Agendamiento automático y calendario digital",
      "Pagos vía Mercado Pago",
      "Ficha clínica y gestión de pacientes",
...
const PLANES_CORPORATIVO = [
  {
    ...
    price: "$129.900",
    period: "/mes + IVA",
    desc: "Para clínicas y centros con 3 o más profesionales. Gestión centralizada y reportería.",
    features: [
      "+3 profesionales en una sola cuenta",
      "Flujos de trabajo por área clínica",
      "Panel administrativo y contable",
      "Reportería ejecutiva por sede",
  ...
  },
  {
    ...
    price: "A cotizar",
    period: "",
    desc: "Para instituciones con requerimientos de seguridad, personalización y escala.",
    features: [
    ...
    flujo: "email",
    activacion: "Nuestro equipo te contacta para coordinar condiciones y precio.",
  },
];
