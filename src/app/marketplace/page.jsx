...
const PROFESSIONALS = [
    {
        ...
        rating: 4.9,
        reviews: 204,
        description: "Nutricionista experta en alimentación saludable y personalizada.",
        image: "/doctores1.png", // Using placeholder for now
        location: "Santiago",
        available: true,
    },
    {
        ...
        image: "/doctores1.png", // Placeholder
    ...
    },
    {
        ...
        rating: 4.7,
        reviews: 139,
        description: "Especialista en rehabilitación física y deportiva.",
        image: "/doctores1.png", // Placeholder
        location: "Concepción",
        available: true,
    },
...
function SidebarFilterItem({ label, active }) {
    return (
        <div className={`p-4 border-b border-slate-100 flex items-center justify-between cursor-pointer hover:bg-slate-50 ${active ? 'bg-slate-50' : ''}`}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 text-slate-400 transition-transform ${active ? 'transform rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
            </svg>
        </div>
    )
